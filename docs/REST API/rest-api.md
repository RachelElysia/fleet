...
| Name                              | Type    | In    | Description                                                                                                                                                                            |
| ---------------------             | ------- | ----  | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| org_name                          | string  | body  | _Organization information_. The organization name. (Required)                                                                                                                          |
| org_logo_url                      | string  | body  | _Organization information_. The URL of the organization's logo.                                                                                                                        |
| org_logo_url_light_background     | string  | body  | _Organization information_. The URL of the organization's logo optimized for display on light backgrounds in Fleet.                                                                    |
| contact_url                       | string  | body  | _Organization information_. A URL for end users to contact the organization.                                                                                                           |
| server_url                        | string  | body  | _Server settings_. The URL of the Fleet server. (Required)                                                                                                                             |
| enable_analytics                  | boolean | body  | _Server settings_. Determines whether anonymous usage statistics are sent. Always enabled for Fleet Premium customers.                                                                 |
| live_query_disabled               | boolean | body  | _Server settings_. Determines whether live query capabilities are disabled.                                                                                                            |
| query_reports_disabled            | boolean | body  | _Server settings_. Determins whether query report capabilities are disabled.                                                                                                           |
| ai_features_disabled              | boolean | body  | _Server settings_. Determines whether AI features are disabled.                                                                                                                        |
| enable_smtp                       | boolean | body  | _SMTP settings_. Determines whether SMTP is enabled for the Fleet application.                                                                                                         |
| sender_address                    | string  | body  | _SMTP settings_. The sender email address for the Fleet application, required to enable SMTP. Used for various automated emails, such as invitation emails.                            |
| server                            | string  | body  | _SMTP settings_. The SMTP server address for the Fleet application, required to enable SMTP.                                                                                           |
| port                              | integer | body  | _SMTP settings_. The SMTP server port for the Fleet application, required to enable SMTP.                                                                                              |
| authentication_type               | string  | body  | _SMTP settings_. The authentication type used by the SMTP server. Options are `"authtype_username_and_password"` or `"none"`.                                                          |
| username_name                     | string  | body  | _SMTP settings_. The username for authenticating requests to the SMTP server when using `"authtype_username_and_password"`.                                                            |
| password                          | string  | body  | _SMTP settings_. The password for authenticating requests to the SMTP server when using `"authtype_username_and_password"`.                                                            |
| enable_ssl_tls                    | boolean | body  | _SMTP settings_. Determines whether SSL and TLS are enabled for the SMTP server.                                                                                                       |
| authentication_method             | string  | body  | _SMTP settings_. The method used to authenticate requests to the SMTP server. Options are `"authmethod_plain"`, `"authmethod_cram_md5"`, and `"authmethod_login"`.                     |
| domain                            | string  | body  | _SMTP settings_. The domain for the SMTP server.                                                                                                                                       |
| verify_ssl_certs                  | boolean | body  | _SMTP settings_. Determines whether SSL certificates are verified by the SMTP server. Set to false (not recommended) if using a self-signed certificate.                               |
| enabled_start_tls                 | boolean | body  | _SMTP settings_. Enables the use of STARTTLS if it's available on the SMTP server.                                                                                                     |
| enabled_sso                       | boolean | body  | _SSO settings_. Determines whether SSO is enabled for the Fleet application. If enabled, most of the SSO settings parameters below must also be included.                              |
| entity_id                         | string  | body  | _SSO settings_. The required entity ID (a URI) used to identify Fleet when configuring the identity provider.                                                                          |
...
| idp_name                          | string  | body  | _SSO settings_. The name of the identity provider, required to enable SSO.                                                                                                             |
| idp_image_url                     | string  | body  | _SSO settings_. An optional URL for an image (such as a logo) representing the identity provider.                                                                                      |
| metadata                          | string  | body  | _SSO settings_. The metadata provided by the identity provider. Either metadata or a metadata URL must be provided.                                                                    |
| metadata_url                      | string  | body  | _SSO settings_. A URL referencing the identity provider metadata. This is the preferred method of providing metadata if available from the identity provider.                          |
...
| host_expiry_enabled               | boolean | body  | _Host expiry settings_. Enables automatic removal of hosts that have not communicated with Fleet for a specified period.                                                               |
| host_expiry_window                | integer | body  | _Host expiry settings_. The number of days after which an inactive host will be removed if host expiry is enabled.                                                                     |
| activity_expiry_enabled           | boolean | body  | _Activity expiry settings_. Enables automatic cleanup of activities (including associated live query data) older than a specified number of days.                                      |
| activity_expiry_window            | integer | body  | _Activity expiry settings_. The number of days to retain activity records when activity expiry is enabled.                                                                             |
| agent_options                     | objects | body  | The agent_options specification applied to all hosts. Note: In Fleet 4.0.0, the `api/v1/fleet/spec/osquery_options` endpoints were removed.                                            |
| transparency_url                  | string  | body  | _Fleet Desktop_. An optional URL for displaying transparency information to Fleet Desktop users. Default: [https://www.fleetdm.com/transparency](https://www.fleetdm.com/transparency) **Requires Fleet Premium license**  |
| enable_host_status_webhook        | boolean | body  | _webhook_settings.host_status_webhook settings_. Determines whether the host status webhook is enabled.                                                                                |
| destination_url                   | string  | body  | _webhook_settings.host_status_webhook settings_. The URL to deliver the webhook request to.                                                                                            |
| host_percentage                   | integer | body  | _webhook_settings.host_status_webhook settings_. The minimum percentage of hosts that must fail to check in with Fleet to trigger the webhook request.                                 |
| days_count                        | integer | body  | _webhook_settings.host_status_webhook settings_. The minimum number of consecutive days the configured `host_percentage` must fail to check in with Fleet to trigger the webhook.      |
| enable_failing_policies_webhook   | boolean | body  | _webhook_settings.failing_policies_webhook settings_. Determines whether the failing policies webhook is enabled..                                                                     |
| destination_url                   | string  | body  | _webhook_settings.failing_policies_webhook settings_. The URL where the webhook request will be sent.                                                                                  |
| policy_ids                        | array   | body  | _webhook_settings.failing_policies_webhook settings_. An array of policy IDs for which to enable the failing policies webhook.                                                         |
...
| enable_vulnerabilities_webhook    | boolean | body  | _webhook_settings.vulnerabilities_webhook settings_. Determines whether the vulnerabilities webhook is enabled.                                                                        |
| destination_url                   | string  | body  | _webhook_settings.vulnerabilities_webhook settings_. The URL where the webhook request will be sent.                                                                                   |
| host_batch_size                   | integer | body  | _webhook_settings.vulnerabilities_webhook settings_. The maximum number of hosts to include in a single failing policy webhook request. Default is 0 (no batching, all hosts in one request). |
...
| destination_url                   | string  | body  | _webhook_settings.activities_webhook settings_. The URL where the webhook request will be sent.                                                                                        |
| enable_software_vulnerabilities   | boolean | body  | _integrations.jira[] settings_. Enables Jira integration for software vulnerabilities. Note: Only one vulnerability automation can be active at a time (either `enable_vulnerabilities_webhook` or `enable_software_vulnerabilities`). |
| enable_failing_policies           | boolean | body  | _integrations.jira[] settings_. Enables Jira integration for failing policies. Note: Only one failing policy automation can be active at a time (either `enable_failing_policies_webhook` or `enable_failing_policies`). |
| url                               | string  | body  | _integrations.jira[] settings_. The URL of the Jira server for integration.                                                                                                            |
| username                          | string  | body  | _integrations.jira[] settings_. The Jira username for this Jira integration.                                                                                                           |
| api_token                         | string  | body  | _integrations.jira[] settings_. The API token associated with the Jira username for this integration.                                                                                  |
| project_key                       | string  | body  | _integrations.jira[] settings_. The Jira project key where tickets will be created for this integration.                                                                               |
| enable_software_vulnerabilities   | boolean | body  | _integrations.zendesk[] settings_. Enables Zendesk integration for software vulnerabilities. Note: Only one vulnerability automation can be active at a time (either `enable_vulnerabilities_webhook` or `enable_software_vulnerabilities`). |
| enable_failing_policies           | boolean | body  | _integrations.zendesk[] settings_. Enables Zendesk integration for failing policies. Note: Only one failing policy automation can be active at a time (either `enable_failing_policies_webhook` or `enable_failing_policies`). |
| url                               | string  | body  | _integrations.zendesk[] settings_. The URL of the Zendesk server for integration.                                                                                                      |
| email                             | string  | body  | _integrations.zendesk[] settings_. The Zendesk user email for this integration.                                                                                                        |
| api_token                         | string  | body  | _integrations.zendesk[] settings_. The Zendesk API token for this integration.                                                                                                         |
| group_id                          | integer | body  | _integrations.zendesk[] settings_. The Zendesk group ID where tickets will be created for this integration.                                                                            |
| domain                            | string  | body  | _integrations.google_calendar[] settings_. The domain of the Google Workspace service account for this calendar integration.                                                           |
...
| apple_bm_default_team             | string  | body  | _mdm settings_. The default team identifier for Apple Business Manager integration.                                                                                                    |
